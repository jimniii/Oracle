 ...
 GRANT CONNECT,RESOURCE,UNLIMITED TABLESPATE TO SHOP;
 EXIT;
 ...
 CREATE TABLE ORDERS(
 ORD_NO NUMBER GENERATED BY DEFAULT AS IDENTITY,
 ...
 INSERT INTO CUSTOMER VALUES('C105','이성계','010-1234-1005','','2022-01-05');
 INSERT INTO CUSTOMER VALUES('C106','정철','010-1234-1006','경기도 용인시','2022-01-06');
 INSERT INTO CUSTOMER VALUES('C107','허준','010-1234-1007','','2022-01-07');
 ...
 INSERT INTO PRODUCT VALUES(5,'죠리퐁',2200,'','크라운');
...
SELECT * FROM PRODUCT;
 ...
 SELECT CID,NAME,HP,ADDRESS FROM CUSTOMER WHERE NAME LIKE '%%';
 ...
 SELECT * FROM ORDERS WHERE ORD_CNT >=3 ORDER BY ORD_CNT DESC;
 ...
 SELECT ORD_PNO AS "주문 상품 번호", SUM(ORD_CNT) AS "총 주문수량" 
 FROM ORDERS GROUP BY ORD_PNO ORDER BY ORD_PNO;
 
 -- 실습 1-26
 
 SELECT COMPANY AS 제조업체, COUNT(*) 제품수, MAX(PRICE) AS 최고가 FROM PRODUCT
 GROUP BY COMPANY;
 ...
 // like도 가능 
 // where substr(ord_date,1,10) = '2022-07-03'도 가능함